  ...
  return (
    <Layout name={post && post.name}>
      <div className="admin_add_workout admin_page">
        ...
        >
          <option value="" disabled={postData.category !== ""}>
            ..
          </option>
          {blog_categories &&
            blog_categories.map((el, i) => (
        ...
        <label>
          Autor <span className="form_required">*</span>
        </label>
        ...
        />
        <label>
          Sisu <span className="form_required">*</span>
        </label>
        ...
        <Link
          href="/private/admin/posts?num=10"
