            ...
            <Fragment>
              <div className="admin_analytics">
                ...
                <Card
                  ...
                  name="eTreeningute külastatavus"
                  icon="fas fa-thumbs-up"
                />
                <Card
                  num={
                    analytics
                      .filter((el) => el.category === "fitness")
                      .filter(
                        (el) =>
                          new Date(el.createdAt).toLocaleDateString() ===
                          selectedDate.toLocaleDateString(),
...
const Anchor = ({ name, link, num }) => {
  ...
  return (
    <Link
      href={`/private/admin/analytics?page=${link}&num=${num}`}
