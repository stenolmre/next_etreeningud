...
export default function Admins({ isOwner }) {
  ...
  return (
    <Layout
      ...
      searchbox
      placeholder="Otsi administraatorit"
        ...
        {loading ? (
          ...
          admins
            ...
            .map((el, i) => (
              <div
                key={el._id}
                className="admin_row admin_list admin_list_admins"
              >
                <p>{i + 1}.</p>
                <p>{el.name}</p>
                ...
                {admin && (
                  <div>
                    {admin._id === el._id && (
                      <Link href={`/private/admin/editadmin?id=${el._id}`}>
                    ...
                    {admin.isOwner && (
                      <i
                        ...
                        onClick={async () => {
                          if (
                            confirm(
                              "Kas sa oled kindel, et soovid administraatori kustutada?",
                            )
                          ) {
...
const Header = () => (
  <div className="admin_row_header admin_row_header_admins">
    <p>#</p>
    <p>Nimi</p>
    <p>Email</p>
    <p>Staatus</p>
