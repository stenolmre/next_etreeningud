    ...
    <div className="admin_page">
      <Header />
      {
        loading ? <div className="admin_loader"><Loader /></div> : <Fragment>
          ...
          {
            numOfLoadedWorkouts < 10 || numOfLoadedWorkouts >= numOfWorkouts ? null : <p onClick={() => router.push(`/private/admin/yoga?num=${numOfLoadedWorkouts + 10}`, undefined, { shallow: true })} className="admin_list_load_more_btn">Näita rohkem..</p>
          }
        </Fragment>
      }
    </div>
