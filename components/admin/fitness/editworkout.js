...
export default function EditWorkout() {
  ...
  const addNewWorkout = async () => {
    setProcessing(true)
    await updateWorkout(dispatchFit, query.id, workoutData, () => {
      setSuccess(true)
      setProcessing(false)
    }, () => {
      setError(true)
  ...
  useEffect(() => {
    setWorkoutData(workoutData => ({ ...workoutData,
  ...
  return <Layout name="Muuda Treeningut">
    <div className="admin_add_workout admin_page">
      ...
      <select name="category" id="category" value={workoutData.category} onChange={e => setWorkoutData({ ...workoutData, category: e.target.value })}>
      ...
      <select name="equipment" id="equipment" value={workoutData.equipment} onChange={e => setWorkoutData({ ...workoutData, equipment: e.target.value })}>
